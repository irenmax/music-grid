...
var app = (function () {
    ...
    let scales = {
    	...
    	classic_2: ["B#6", "B#6", "G6", "F6", "D6", "B#5", "A5", "G5", "F5", "D5", "B#4", "A4"],
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			h3 = element("h3");
    			h3.textContent = "Music Grid";
    			t1 = space();
    			span = element("span");
    			t2 = text("Turn on sound. Tap on the grid.");
    			br0 = element("br");
    			t3 = text("Hit Play. You'll figure it out ;)");
    			t4 = space();
    			br1 = element("br");
    			t5 = space();
